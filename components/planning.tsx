  ...
  return (
    <section id='planning' className='max-w-(--breakpoint-xl) mx-auto w-full'>
      <div className='py-10 px-6'>
        <h2
          data-aos='fade-down'
          className='text-[13px] min-[375px]:text-[15px] min-[400px]:text-base sm:text-2xl md:text-3xl lg:text-4xl whitespace-nowrap md:leading-[1.2] font-semibold tracking-[-0.03em] sm:max-w-2xl sm:mx-auto sm:text-center'>
